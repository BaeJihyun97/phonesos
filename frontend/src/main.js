...
pluralCaseList.push( {plural: "users/devices", pascal: "UserDevice"} )

pluralCaseList.push( {plural: "lossreports/lostItemReports", pascal: "LossreportLostItemReport"} )

pluralCaseList.push( {plural: "rentals/deviceRentals", pascal: "RentalDeviceRental"} )
